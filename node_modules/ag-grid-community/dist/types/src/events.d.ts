...
/** BATCH EVENTS */
/**--------------*/
export interface BatchEditingEvent<T extends AgEventType, TData = any, TContext = any> extends AgGlobalEvent<T, TData, TContext> {
...
export interface CellClickedEvent<TData = any, TValue = any, TContext = any> extends CellEvent<'cellClicked', TData, TValue, TContext> {
}
export interface CellMouseDownEvent<TData = any, TValue = any, TContext = any> extends CellEvent<'cellMouseDown', TData, TValue, TContext> {
}
export interface CellDoubleClickedEvent<TData = any, TValue = any, TContext = any> extends CellEvent<'cellDoubleClicked', TData, TValue, TContext> {
}
